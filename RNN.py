...
model.add(Input(shape=(64,64))) # seq_length, input_size
model.add(SimpleRNN(128, return_sequences=False, activation='relu')) # N, 128
...
# Modeli eğitin
training = model.fit(x_train, y_train, epochs=32, batch_size=64, validation_data=(x_test, y_test))
